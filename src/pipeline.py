...
def train_pipeline_parallel(args):
    ...
    output_dir = f"{args.output_dir}/{model_name}_dspp_lora_r{args.lora_r}_ep{args.num_train_epochs}_lr{args.learning_rate}_bs{args.per_device_train_batch_size}_{timestamp}"
    os.makedirs(output_dir, exist_ok=True)

    # === DeepSpeed config path ===
    ds_config_path = args.deepspeed_config  # Must point to a JSON file with pipeline parallelism setup
    ...
    print("\nStarting training using DeepSpeed-based pipeline parallelism...")
    ...
    summary_metrics = {
        ...
        "model": args.model_id,
        "parallelization": "accelerate+deepspeed_pipeline"
    }
